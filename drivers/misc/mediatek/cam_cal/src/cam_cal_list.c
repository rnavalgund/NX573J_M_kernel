...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{S5K3P3SX_SUB_QTECH_SENSOR_ID, 0xA2, CMD_AUTO, cam_cal_check_mtk_cid_ztemt},//added by ztemt kangxiong for 541 eeprom
	{IMX258_MAIN_SZSEASON_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid_ztemt},
	{S5K3P3SX_SUB_SUNWIN_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid_ztemt},
